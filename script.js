...
const config = {
  style: 'mapbox://styles/benchspotters/cliw989wm001l01pm9lkybjpy', 
  accessToken:
    'pk.eyJ1IjoiYmVuY2hzcG90dGVycyIsImEiOiJjbGJrdnAycXQwMW1rM25waXF1dHQ4djRhIn0.k00FDSeJrdDFoV_tMw7tLQ',
  CSV: 'https://docs.google.com/spreadsheets/d/126QXR3xSbTX1Xe3XnNa89V_Km9Eo3Y2KcyFhENQriFA/gviz/tq?tqx=out:csv&sheet=Sheet1',
  center: [44.80309791420782, 41.69305896965968],  
  zoom: 13,
  title: 'ბენოს რუკა [benos ruk’a]',
  description:
    '"this is a map with all our favourite locations in tbilisi. ill try to sync this map with our doc, so that locations appear automatically. and ideally, ill try to make it mobile-friendly as well so that we can use it once were there. jtm, beno"' ,
  sideBarInfo: ['name', 'address'], 
  popupInfo: ['name'],
  popupInfo2: ['link'],
  popupInfo3: ['address'],
  filters: [
...
function createPopup(currentFeature) {
  ...
  '<h3><strong>' +
    ...
    '" target="_blank">more info</a></p>' + '</h3>'
)
    .addTo(map);
}
